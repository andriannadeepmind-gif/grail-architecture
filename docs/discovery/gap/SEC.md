...
| REQ-SEC-002 | ισχύει | Εκτελούνται μόνο reproducible, υπογεγραμμένα artifacts με SBOM/provenance (OPS-01, KRN-04· ICD-04· S03· VT-803). | Ως απαίτηση ισχύει και επαληθεύεται με VT-803 (unsigned refusal) και in-toto attestations. Το SBOM να είναι SPDX ή CycloneDX 1.7 / ECMA-424, με CBOM. Η αυστηροποίηση του μηχανισμού αφορά την INV-S03. Δεν βρέθηκε αυστηρά ανώτερη διατύπωση. | σήμερα · υψηλή | [in-toto attestation, n.d.](https://github.com/in-toto/attestation) · [CycloneDX overview, 2025](https://cyclonedx.org/specification/overview/) |

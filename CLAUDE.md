...
- Ο **ΑΠΟΛΥΤΟΣ ΝΟΜΟΣ ΜΗ ΥΠΟΒΑΘΜΙΣΗΣ** είναι κατατεθειμένος αυτούσιος στο `docs/NOMOS-MI-YPOVATHMISIS.md` και διέπει το έργο· τρία άρθρα του είναι πύλες στη Δ-8(ια).
- Τίποτα μέτριο· 0 λάθος· μία έδρα ανά έννοια· τίμια άγνοια («δεν ξέρω» αντί για εικασία, ποτέ αντί για κρίση)· μόνο ο δημιουργός εγκρίνει.

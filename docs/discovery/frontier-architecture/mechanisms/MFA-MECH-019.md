...
| **19. Διάψευση** | Αν σε ΚΑΜΙΑ οικογένεια έργων το μείγμα δεν ξεπερνά τον καλύτερο μεμονωμένο πάροχο με διακριτικό περιθώριο μετά από N επεισόδια → το PDE είναι FALSIFIED ως μηχανισμός βελτίωσης (0.4.0: ήδη δρομολόγηση, §4 RSI ≠ routing)· η ενδογενής βελτίωση ΜΕΝΕΙ στόχος (RVSI MFA-MECH-022, STP MFA-MECH-033)· η τίμια δήλωση της επιστημικής κατάστασης καταγράφεται χωριστά (§5) |
